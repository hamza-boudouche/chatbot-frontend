...
import TrelloSliderRemove from '../../TrelloSliderRemove';

const RemoveTasksForm = ({ sendMessageSocket }) => {
		...
		<>
			<div className={`message received`}>
				...
				<form className="form-body">
					<h5>Remove tasks</h5>
					<label className="contained">Remove tasks</label>
					<input
						type="button"
						name="name"
...
export default RemoveTasksForm;
